...
def test_get_course_by_id_exists():
    response = client.get("/courses/6511342ca2af6929cb7b2d2e")
    assert response.status_code == 200
    course = response.json()
    # get the course from the database
    course_db = db.courses.find_one({"_id": ObjectId("6511342ca2af6929cb7b2d2e")})
...
def test_rate_chapter():
    course_id = "6511342ca2af6929cb7b2d2e"
    chapter_id = "1"
    rating = 1
